function Hybrid_Solver_Function_S(node_initals, s_dots, S_ints, final_time, time_res, space_res, max_k)
% Function obtains solutions and plots for general multi-compartment hybrid
% evolution where Schnakenberg reaction kenetics are used.
...
% Schnakenberg reaction kenetics
